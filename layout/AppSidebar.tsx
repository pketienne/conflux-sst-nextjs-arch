...
const AppSidebar = (props: { sidebarRef: React.RefObject<HTMLDivElement> }) => {
	const { layoutConfig, setLayoutState, layoutState } = useContext(LayoutContext);
			...
			<div ref={props.sidebarRef} className="layout-sidebar" onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>
				<div className="sidebar-header">
					<a onClick={navigateToDashboard} className="app-logo cursor-pointer">
						<svg viewBox="0 0 66 19" fill="none" xmlns="http://www.w3.org/2000/svg" className="app-logo-normal">
						...
						<svg width="17" height="20" viewBox="0 0 17 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="app-logo-single h-2rem">
