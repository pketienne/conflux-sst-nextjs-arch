				...
				<div className="px-2">
					...
					{!props.minimal && (
						<>
							...
							<div className="flex flex-wrap row-gap-3">
								<div className="flex align-items-center gap-2 w-6">
									<RadioButton name="menuTheme" value="light" checked={layoutConfig.menuTheme === 'light'} onChange={(e) => onChangeMenuTheme(e.value)} disabled={layoutConfig.colorScheme === 'dark' || isHorizontal()} inputId="menutheme-light"></RadioButton>
									<label htmlFor="menutheme-light">Light</label>
								</div>
								<div className="flex align-items-center gap-2 w-6 pl-2">
									<RadioButton name="menuTheme" value="dark" checked={layoutConfig.menuTheme === 'dark'} onChange={(e) => onChangeMenuTheme(e.value)} disabled={layoutConfig.colorScheme == 'dark' || isHorizontal()} inputId="menutheme-dark"></RadioButton>
							...
							<div className="flex flex-wrap row-gap-3">
								<div className="flex align-items-center gap-2 w-6">
									<RadioButton name="topbarTheme" value="light" checked={layoutConfig.topbarTheme === 'light'} onChange={(e) => onTopbarChangeTheme(e.value)} disabled={layoutConfig.colorScheme === 'dark'} inputId="topbartheme-light"></RadioButton>
									<label htmlFor="topbartheme-light">Light</label>
								</div>
								<div className="flex align-items-center gap-2 w-6 pl-2">
									<RadioButton name="topbarTheme" value="dark" disabled={layoutConfig.colorScheme === 'dark'} checked={layoutConfig.topbarTheme === 'dark'} onChange={(e) => onTopbarChangeTheme(e.value)} inputId="topbartheme-dark"></RadioButton>
