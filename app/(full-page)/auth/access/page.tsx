		...
		<>
			<div>
				<div className="flex align-items-center py-0 px-3 w-full z-2 px-5" style={{ height: '62px', boxShadow: '0 10px 40px 0 rgb(41 50 65 / 6%)', background: 'var(--surface-card)' }}>
					<a id="logolink" onClick={navigateToDashboard} style={{ cursor: 'pointer' }}>
				...
				<div className="flex flex-column justify-content-center align-items-center" style={{ minHeight: 'calc(100vh - 62px)' }}>
					<div className="flex flex-column justify-content-center">
						<img src="/layout/images/pages/asset-access.svg" alt="freya-layout" style={{ width: '332px', height: '271px' }} />
						<span className="block text-7xl text-center">access denied</span>
					</div>
